...
public class DateTime implements Cloneable, Comparable<DateTime>
{
   ...
   public void addDayOfYear(int days) {gc.add(Calendar.DAY_OF_YEAR, days);}
   
   public int getYear() {return gc.get(Calendar.YEAR);}
   public int getMonth() {return gc.get(Calendar.MONTH) + 1;}
   public int getDay() {return gc.get(Calendar.DAY_OF_MONTH);}
   public int getDayOfYear() {return gc.get(Calendar.DAY_OF_YEAR);}
   public int getDayOfWeek() {return gc.get(Calendar.DAY_OF_WEEK);}
   public int getDayOfMonth() {return gc.get(Calendar.DAY_OF_MONTH);}
   public int getHour() {return gc.get(Calendar.HOUR);}
   public int getHourOfDay() {return gc.get(Calendar.HOUR_OF_DAY);}
   public int getMinute() {return gc.get(Calendar.MINUTE);}
   public int getSecond() {return gc.get(Calendar.SECOND);}
   public int getMillisecond() {return gc.get(Calendar.MILLISECOND);}
